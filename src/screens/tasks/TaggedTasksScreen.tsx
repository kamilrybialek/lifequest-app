...
export const TaggedTasksScreen = ({ navigation, route }: any) => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const tasksData = await getTasks(user.id, { tagId });
      setTasks(tasksData);
    } catch (error) {
  ...
  const renderEmpty = () => (
    <View style={styles.emptyContainer}>
      {tag && <Text style={styles.emptyIcon}>{tag.icon}</Text>}
      <Text style={styles.emptyTitle}>No tasks with this tag</Text>
      <Text style={styles.emptySubtitle}>Add this tag to your tasks</Text>
      <TouchableOpacity
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          {tag && (
            <View style={[styles.tagBadge, { borderColor: tag.color || colors.border }]}>
              {tag.icon && <Text style={styles.headerIcon}>{tag.icon}</Text>}
